...
const CommitteeDetail = () => {
    ...
    const committees = {
        ...
        'unca-journalism': {
            ...
            writeup: [
                `"When the people will to live, Destiny must surely respond" - Abul-Qacem Echebbi, Tunisian poet`,
                `The Arab Spring began, as most revolutions often do: with silence. In December 2010, when Mohamed Bouazizi set himself ablaze in Sidi Bouzid, the Tunisian state attempted to erase the radical act of self-immolation from public memory through an aggressive media blackout. What followed exposed a fundamental tension at the heart of modern political power: the desire of authoritarian regimes to control narratives, and the growing impossibility of doing so in a digitised world. The blackout was no longer a barrier but a provocation. The Tunisian Revolution demonstrated that control over territory no longer guaranteed control over meaning. Power struggled to keep pace with a media ecology that was fragmented, transnational, and resistant to central authority. This dynamic reverberated across the region, inspiring movements in Egypt, Libya, Yemen, and beyond. Tunisia became both a political and communicative blueprint for revolt.`,
                `This agenda asks delegates to examine the media not as a neutral backdrop to revolution, but as a contested site of power. Bouazizi's act exposed not only economic precarity but a deeper democratic deficit, where grievance had no lawful channel.`,
                ...
                `Every journalist is allotted a news agency, which becomes their portfolio for the rest of the conference. Journalists are obligated to adopt the bias of their news agency throughout reporting and committee sessions, which depends on several factors such as ownership, political affiliations, and the country in which their news agency is based. Admitting one's bias goes against the ethics of journalism; hence, no news agency can ever own up to being prejudiced, which provides news agencies a nuance most other portfolios lack.`,
                `Over the three days of the conference, journalists will be mandated to compose a myriad of articles of varied kinds. For example: Position Papers, Feature pieces, Analytical and Counter Analytical pieces, Opinion Editorials, Press Conference critiques, Beats, Case Studies, and more.`,
                `UNCA's journalists also have the unique opportunity to conduct press conferences, where they interrogate the delegates of their allotted sub-committees. Here, they possess the power to hold the delegates accountable by posing critically thought-out questions on pertinent issues. Journalists are expected to garner solidarity towards their bias through the press conference proceedings.`,
        ...
        'unca-photography': {
            ...
            writeup: [
                `The photographers are an essential part of SMUN. Being a part of this committee, a photographer must capture the pivotal moments and provide an artistic perspective through each image. From covering the mundane committee proceedings to dramatic crisis sessions, the UNCA photographers aim to shed light to the unnoticed. To be a successful delegate of this committee, one must capture the essence of SMUN.`,
                `The committee sessions of the UNCA-Photographers will be segregated into photography sessions, and crisis sessions. During photography sessions, photographers will be required to work on their tasks and submissions and during crisis sessions, photographers will have to use their skills under high pressure circumstances and work as a team. The crisis challenges the delegates' photography skills in a way that inspires creative thinking under pressure. Unlike regular tasks, where delegates work individually, the crisis is based on teamwork. It includes constraints, quick thinking and a tight deadline. The delegates may also be required to participate in an Unmoderated Caucus by informally debating and creating alliances, working with, or against each other.`,
                ...
                `Captions enable the delegates to put into words their unique perspectives and capture the essence of the conference. For each picture, the delegates are required to write a caption which describes the ideas of the subject and committee proceedings, all while keeping in mind their agency biases.`,
                `Each delegate is allotted a news agency, and their role is to reflect that agency's history, rivalries, and most importantly, its biases. Understanding these biases allows delegates to capture moments and write captions that reflect their agency's perspective. These biases may be political, ideological, or regional in nature. For instance, a delegate representing The Jerusalem Post would take photographs and craft captions aligned with the interests and stances of the State of Israel.`,
                `Delegates are assigned committees to record videos of the Press Conference in. A committee-wise schedule for the Press Conference is given out to the delegates.`,
        ...
        'unca-cartoonists': {
            ...
            writeup: [
                `In an age awash with information and yet governed by silence, an unnamed voice dared to speak through the hush of power. One mail, 11.5 million documents, 2.6 terabytes of enforced obscurity. On 3rd April 2016, what the world witnessed was not merely the biggest information leak of history; it was a collective outcry of truths long buried and voices long silenced. The Panama Papers exposed an intricate network of financial secrecy that entangled political leaders, multinational corporations, and elites across the globe. These revelations reverberated across the globe, faltering governments, intensifying public outrage, and dragging elites into the light of unforgiving scrutiny.`,
                `In the wake of the Panama Papers, journalists across the globe were reminded of the cost of deviance. Surveillance became routine, harassment and threats against journalists were orchestrated and the very institutions tasked with protecting free expression stood complicit in its erosion. Delegates, each one of you is entrusted to navigate through this profound rupture. Newsrooms work under siege, encircled by surveillance and intimidation of state machineries. The lines between national security and political self-preservation are actively being blurred. Will the press continue to challenge entrenched power structures, even at its own institutional cost? Delegates, the fate of the press teeters on your pens.`,
                `At SMUN, cartoonists function as visual narrators, translating committee debates, negotiations and tensions into nuanced emotions and imagery. The committee sessions would be divided into cartooning sessions and crisis sessions. During the cartooning sessions, delegates will work on their assigned task, while during crisis sessions, they will deliberate and debate on the crisis at hand.`,
                `Over the course of the conference, the delegates will be assigned various tasks, all of which must be completed and submitted by set deadlines. Tasks include Illustratives, Comic Scripts, Caricatures, Perspective Cartoons, Object-Based Cartoons, amongst others. Their role is to observe the proceedings of their sub-committee and capture the essence of political speeches, debates, and crises, translating them into impactful caricatures that utilize humour and satire. Cartoonists will also be participating in a press conference, wherein they will be posing challenging yet indispensable questions to the delegates in their assigned sub-committee.`,
                `Cartoonists serve as representatives of their allotted news agencies and will be required to navigate through the finer distinctions of reporting. Delegates are expected to take into account their news agencies' political affiliations, ownership, the socio-political context, and demonstrate it consistently throughout the conference, in both their cartoons and the arguments they present during crisis speeches. They are required to actively partake in committee proceedings, adhere to the deadlines of task submissions, and convey their stance and propose viable solutions during verbal crises.`
            ]
        }
    };
